...
public class GUILaporanBarang extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            if (sql.getConnection() == null) {
                JOptionPane.showMessageDialog(this, "Database tidak terkoneksi!");
                return;
            }
            ...
            // Tampilkan viewer dan set visible
            JasperViewer viewer = new JasperViewer(jp, false);
            viewer.setTitle("Laporan Data Barang");
            viewer.setVisible(true); // Jangan lupa menambahkan ini
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUILaporanBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
